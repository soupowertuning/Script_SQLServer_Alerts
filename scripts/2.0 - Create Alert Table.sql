...
VALUES	('Version DB CheckList ',				'2.0',@Fl_Language,									0,1,		NULL,	NULL,			@Ds_Profile_Email,	@Ds_Email,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),
		...
		('CPU Utilization',						'stpAlert_CPU_Utilization',@Fl_Language,					1,1,		85,		'Percent',	@Ds_Profile_Email,	@Ds_Email,'ALERT: CPU utilization in 5 Minutes is greater than ###1% on Server: ','CLEAR: CPU utilization in 5 Minutes is lower than ###1% on Server:    'ALERTA: O Consumo de CPU em 5 minutos está acima de ###1% no Servidor: ','CLEAR: O Consumo de CPU em 5 minutos está abaixo de ###1% no Servidor: ','CPU Utilization in Last 5 Minutes','TOP 50 - Process Executing on Database','Consumo de CPU no Servidor nos Últimos 5 Minutos','TOP 50 - Processos executando no Banco de Dados'),
